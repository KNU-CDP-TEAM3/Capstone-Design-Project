...
public abstract class Hilt_SpeedFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SpeedFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SpeedFragment_GeneratedInjector) this.generatedComponent()).injectSpeedFragment(UnsafeCasts.<SpeedFragment>unsafeCast(this));
    }
  }
