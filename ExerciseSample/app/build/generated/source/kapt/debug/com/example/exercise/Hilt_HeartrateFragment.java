...
public abstract class Hilt_HeartrateFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HeartrateFragment() {
    super();
  }

  Hilt_HeartrateFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HeartrateFragment_GeneratedInjector) this.generatedComponent()).injectHeartrateFragment(UnsafeCasts.<HeartrateFragment>unsafeCast(this));
    }
  }
