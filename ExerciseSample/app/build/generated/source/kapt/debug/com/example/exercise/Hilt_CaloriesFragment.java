...
public abstract class Hilt_CaloriesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CaloriesFragment() {
    super();
  }

  Hilt_CaloriesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CaloriesFragment_GeneratedInjector) this.generatedComponent()).injectCaloriesFragment(UnsafeCasts.<CaloriesFragment>unsafeCast(this));
    }
  }
