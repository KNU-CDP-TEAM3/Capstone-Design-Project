...
public final class FragmentExerciseBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView spO2Icon;

  @NonNull
  public final TextView spO2Text;
  ...
  private FragmentExerciseBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageView spO2Icon, @NonNull TextView spO2Text, @NonNull ImageView speedIcon,
      @NonNull TextView speedText, @NonNull Button startEndButton) {
  ...
  public static FragmentExerciseBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.spO2_icon;
      ImageView spO2Icon = ViewBindings.findChildViewById(rootView, id);
      if (spO2Icon == null) {
        break missingId;
      }

      id = R.id.spO2_text;
      TextView spO2Text = ViewBindings.findChildViewById(rootView, id);
      if (spO2Text == null) {
        break missingId;
      }
      ...
      return new FragmentExerciseBinding((ConstraintLayout) rootView, caloriesIcon, caloriesText,
          ...
          heartRateText, lapsIcon, lapsText, pauseResumeButton, spO2Icon, spO2Text, speedIcon,
          speedText, startEndButton);
    }
