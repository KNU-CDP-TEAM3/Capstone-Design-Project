...
public abstract class Hilt_LapsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LapsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LapsFragment_GeneratedInjector) this.generatedComponent()).injectLapsFragment(UnsafeCasts.<LapsFragment>unsafeCast(this));
    }
  }
