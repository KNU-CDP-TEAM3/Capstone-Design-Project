...
public abstract class Hilt_DistanceFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DistanceFragment() {
    super();
  }

  Hilt_DistanceFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DistanceFragment_GeneratedInjector) this.generatedComponent()).injectDistanceFragment(UnsafeCasts.<DistanceFragment>unsafeCast(this));
    }
  }
