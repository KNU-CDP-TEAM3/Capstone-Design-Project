...
public abstract class Hilt_HeartFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HeartFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HeartFragment_GeneratedInjector) this.generatedComponent()).injectHeartFragment(UnsafeCasts.<HeartFragment>unsafeCast(this));
    }
  }
