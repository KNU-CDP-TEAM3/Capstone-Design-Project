...
public final class FragmentExerciseBinding implements ViewBinding {
  ...
  private FragmentExerciseBinding(@NonNull LinearLayout rootView, @NonNull TextView blankText,
      ...
      @NonNull TextView elapsedTime, @NonNull ImageView heartRateIcon,
      @NonNull TextView heartRateText, @NonNull ImageView lapsIcon, @NonNull TextView lapsText,
      @NonNull Button pauseResumeButton, @NonNull ScrollView scrollView,
      @NonNull ImageView speedIcon, @NonNull TextView speedText, @NonNull Button startEndButton) {
  ...
  public static FragmentExerciseBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.blank_text;
      TextView blankText = ViewBindings.findChildViewById(rootView, id);
      if (blankText == null) {
        break missingId;
      }
      ...
      return new FragmentExerciseBinding((LinearLayout) rootView, blankText, caloriesIcon,
          caloriesText, clockIcon, distanceIcon, distanceText, elapsedTime, heartRateIcon,
          heartRateText, lapsIcon, lapsText, pauseResumeButton, scrollView, speedIcon, speedText,
          startEndButton);
    }
